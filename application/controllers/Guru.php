...
class Guru extends CI_Controller
{
    ...
    public function ubah_profil()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('templates/header', $data);
            $this->load->view('templates/guru_sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('guru/ubah-profil', $data);
            $this->load->view('templates/footer');
        } else {
    ...
    public function data_siswa()
    {
        ...
        $config['base_url'] = base_url() . 'guru/data_siswa';
        ...
        $this->load->view('templates/guru_sidebar');
        $this->load->view('templates/topbar', $data);
        $this->load->view('guru/v-data-siswa', $user);
        $this->load->view('templates/footer');
    }
    ...
    public function detail_siswa($nisn)
    {
        ...
        $data['user']  = $this->Modelguru->getTopbarName();
        $detail['siswa']  = $this->ModelSiswa->getSiswaById($nisn);

        $this->load->view('templates/header', $data);
        $this->load->view('templates/guru_sidebar');
        $this->load->view('templates/topbar', $data);
        $this->load->view('guru/v-detail-siswa', $detail);
        $this->load->view('templates/footer');
    }
    ...
    public function data_nilai()
    {
        ...
        $config['base_url'] = base_url() . 'guru/data_nilai';
        $config['total_rows'] = $this->ModelSiswa->totalRows();
        $config['per_page'] = 10;
        ...
        $this->load->view('guru/v-nilai-siswa', $user);
        $this->load->view('templates/footer');
    }
    ...
    public function detail_nilai($nisn)
    {
        ...
        $this->load->view('templates/guru_sidebar');
        $this->load->view('templates/topbar');
        $this->load->view('guru/v-detail-nilai', $detail);
        $this->load->view('templates/footer');
    }
}
